...
/**
 * This Class is used to generate all the JsonFiles required to generate the different charts required by 
...
public class AMDashboardService extends BaseDashboardService {
	...
	/**
	 * This method generates the JSON file required for generating the Insight Chart for AM .
	 * 
	...
	public InsightData generateInsightData(String orgId, String toolId, String projectId) {
		...
		insData.setTitle("AM Insight");
		insData.setDescription("AM insights shows how good the strategy is ");
		...
		insData = insightDashboardService.generateInsightData(insData, orgId,
				toolId, projectId, CommonConstants.AM_INSIGHT_DASHBOARD_ID);
		logger.debug("generateInsightData: Insight data from AM " + insData);
		
		return insData;
	}
	
	/**
	 * This method generates the JSON file required for generating the Index Chart for AM .
	 * 
	 * @param orgId: The organization Id.
	 * @param toolId: The tool Id.
	 * @param projectId: The project Id.
	...
	public IndexData generateIndexData(String orgId, String toolId, String projectId) {
		...
		indexData.setTitle("AM Index ");
		indexData.setType("Guage");
		indexData.setDescription(
				"AM Index is one of the Key Performance Indicator (KPI), AM Factor Score expressed as a percentage score against the benchmark.");
		...
		writeToFileAndUpdateDashboard(indexData, orgId, toolId, projectId, CommonConstants.AM_INDEX_DASHBOARD_ID);
	...
	/**
	 * This method generates the JSON file required for generating the UserTeam Chart for AM for a particular question .
	 * 
	 * @param orgId: The organization Id.
	 * @param toolId: The tool Id.
	 * @param projectId: The project Id.
	...
	public UserTeamData generateUserTeamData(String orgId, String toolId, String projectId, String qId) {
		...
		UserTeamData userTeamData = userTeamDataService.generateUserTeamData("AM User Team",
				CommonConstants.AM_USERTEAM_DASHBOARD_ID, orgId, toolId, projectId, qId);
	...
	/**
	 * This method generates the JSON file required for generating the UserTeam Chart for AM for all the questions.
	 * 
	 * @param orgId: The organization Id.
	 * @param toolId: The tool Id.
	 * @param projectId: The project Id.
	...
	public ArrayList<UserTeamData> generateUserTeamDataAllQuestions(String orgId, String toolId, String projectId) {
		...
		ArrayList<UserTeamData> userTeamData = userTeamDataService.generateUserTeamDataAllQuestions("AM User Team",
				CommonConstants.AM_USERTEAM_DASHBOARD_ID, orgId, toolId, projectId);
