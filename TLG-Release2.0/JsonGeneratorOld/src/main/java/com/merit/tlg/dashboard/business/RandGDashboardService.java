 ...
 * different charts required by Risk and Governance
 * 
 */
public class RandGDashboardService extends BaseDashboardService {
	final static Logger logger = Logger.getLogger(RandGDashboardService.class);
	...
	public InsightData generateInsightData(String orgId, String toolId, String projectId) {
		...
		insData.setTitle("RG Insight");
		insData.setDescription("RG insights shows how good the strategy is ");
		...
		insData = insightDashboardService.generateInsightData(insData, orgId, toolId, projectId,
				CommonConstants.RG_INSIGHT_DASHBOARD_ID);
		logger.debug("generateInsightData: Insight data from RG " + insData);
	...
	public IndexData generateIndexData(String orgId, String toolId, String projectId) {
		...
		indexData.setTitle("R&G Index ");
		indexData.setType("Guage");
		indexData.setDescription(
				"R&G Index is one of the Key Performance Indicator (KPI), R&G Factor Score expressed as a percentage score against the benchmark.");
		...
		writeToFileAndUpdateDashboard(indexData, orgId, toolId, projectId, CommonConstants.RG_INDEX_DASHBOARD_ID);
		logger.debug("generateIndexData: Completed Writing the index json file for Rand G in the specified folder");
		return indexData;
	}

	/**
	 * This method generates the JSON file required for generating the UserTeam
	 * Chart for RandG for a particular question .
	 * 
	 * @param orgId: The organization Id.
	 * @param toolId: The tool Id.
	 * @param projectId: The project Id.
	...
	public UserTeamData generateUserTeamData(String orgId, String toolId, String projectId, String qId) {
		...
		UserTeamData userTeamData = userTeamDataService.generateUserTeamData("R&G User Team",
				CommonConstants.RG_USERTEAM_DASHBOARD_ID, orgId, toolId, projectId, qId);
	...
	/**
	 * This method generates the JSON file required for generating the UserTeam
	 * Chart for RandG for all the questions.
	 * 
	 * @param orgId: The organization Id.
	 * @param toolId: The tool Id.
	 * @param projectId: The project Id.
	...
	public ArrayList<UserTeamData> generateUserTeamDataAllQuestions(String orgId, String toolId, String projectId) {
		...
		ArrayList<UserTeamData> userTeamData = userTeamDataService.generateUserTeamDataAllQuestions("R&G User Team",
				CommonConstants.RG_USERTEAM_DASHBOARD_ID, orgId, toolId, projectId);
	...
	/**
	 * This method populates the static data for the RandG Index chart.
	 * 
