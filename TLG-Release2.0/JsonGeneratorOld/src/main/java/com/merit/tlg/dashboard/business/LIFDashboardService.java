...
public class LIFDashboardService extends BaseDashboardService {
	...
	public InsightData generateInsightData(String orgId, String toolId, String projectId) {
		...
		insData.setTitle("LIF Insight");
		insData.setDescription("LIF insights shows how good the strategy is ");
		...
		insData = insightDashboardService.generateInsightData(insData, orgId, toolId, projectId,
				CommonConstants.LIF_INSIGHT_DASHBOARD_ID);
		logger.debug("generateInsightData: Insight data from LIF " + insData);
	...
	public IndexData generateIndexData(String orgId, String toolId, String projectId) {
		...
		indexData.setTitle("LIF Summary ");
		indexData.setType("Piechart");
		indexData.setDescription(
				"Show Profile of Business as a pie chart, where each Dimension is one segment of the pie");
		...
		writeToFileAndUpdateDashboard(indexData, orgId, toolId, projectId, CommonConstants.LIF_INDEX_DASHBOARD_ID);
		logger.debug("generateIndexData: Completed Writing the Index json file for LIF in the specified folder");
	 ...
	 * Chart for LIF for a particular question .
	 * 
	 * @param orgId: The organization Id.
	 * @param toolId: The tool Id.
	 * @param projectId: The project Id.
	...
	public UserTeamData generateUserTeamData(String orgId, String toolId, String projectId, String qId) {
		...
		UserTeamData userTeamData = userTeamDataService.generateUserTeamData("LIF User Team",
				CommonConstants.LIF_USERTEAM_DASHBOARD_ID, orgId, toolId, projectId, qId);
	...
	/**
	 * This method generates the JSON file required for generating the UserTeam
	 * Chart for LIF for all the questions.
	 * 
	 * @param orgId: The organization Id.
	 * @param toolId: The tool Id.
	 * @param projectId: The project Id.
	...
	public ArrayList<UserTeamData> generateUserTeamDataAllQuestions(String orgId, String toolId, String projectId) {
		...
		ArrayList<UserTeamData> userTeamData = userTeamDataService.generateUserTeamDataAllQuestions("LIF User Team",
				CommonConstants.LIF_USERTEAM_DASHBOARD_ID, orgId, toolId, projectId);
	...
	/**
	 * This method populates the static data for the LIF Index chart.
	 * 
