 ...
 * different charts required by Structural Dynamic Tool.
 * 
 */
public class SDDashboardService extends BaseDashboardService {
	 ...
	 * (Mean and STDDev Metrics) for Structural Dynamic Tool in the specified
	...
	public InsightData generateInsightData(String orgId, String toolId, String projectId) throws JsonGenException {
		return super.generateInsightData(orgId, toolId, projectId, CommonConstants.SD_INSIGHT_DASHBOARD_ID);
	}

	/**
	 * This method creates the standard JSON file for generating the Index Chart for
	 * Structural Dynamic Tool in the specified location and also returns the Index
	...
	public IndexData generateIndexData(String orgId, String toolId, String projectId) throws JsonGenException {
		return super.generateIndexData(orgId, toolId, projectId, CommonConstants.SD_INDEX_DASHBOARD_ID);
	}

	/**
	 * This method creates the JSON file required for generating the UserTeam Chart
	 * for Structural Dynamic Tool for a particular question in the specified
	...
	public UserTeamData generateUserTeamData(String orgId, String toolId, String projectId, String qId)
		...
		return super.generateUserTeamData(orgId, toolId, projectId, CommonConstants.SD_USERTEAM_DASHBOARD_ID, qId);
	}

	/**
	 * This method generates the JSON file required for generating the UserTeam
	 * Chart for Structural Dynamic Tool for all the questions for the tool in the
	...
	public ArrayList<UserTeamData> generateUserTeamDataAllQuestions(String orgId, String toolId, String projectId)
		...
		return super.generateUserTeamDataAllQuestions(orgId, toolId, projectId,
				CommonConstants.SD_USERTEAM_DASHBOARD_ID);
	}
