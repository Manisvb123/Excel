 ...
 * different charts required by Strategic Planning Process Tool.
 * 
 */
public class SPPDashboardService extends BaseDashboardService {
	 ...
	 * (Mean and STDDev Metrics) for Strategic Planning Process Tool in the
	 * specified location and also returns the Insight Data in the form of a bean.
	 * 
	...
	public InsightData generateInsightData(String orgId, String toolId, String projectId) throws JsonGenException {
		return super.generateInsightData(orgId, toolId, projectId, CommonConstants.SPP_INSIGHT_DASHBOARD_ID);
	}

	/**
	 * This method creates the standard JSON file for generating the Index Chart for
	 * Strategic Planning Process Tool in the specified location and also returns
	 * the Index Data in the form of a bean.
	 * 
	 * @param orgId: The organization Id.
	 * @param toolId: The tool Id.
	 * @param projectId: The project Id.
	...
	public IndexData generateIndexData(String orgId, String toolId, String projectId) throws JsonGenException {
		return super.generateIndexData(orgId, toolId, projectId, CommonConstants.SPP_INDEX_DASHBOARD_ID,
				CommonConstants.SPP_INDEX_DASHBOARD_ID);
	}

	/**
	 * This method creates the JSON file required for generating the UserTeam Chart
	 * for Strategic Planning Process Tool for a particular question in the
	 * specified location and also returns the UserTeam Data in the form of a bean.
	 * 
	 * @param orgId: The organization Id.
	 * @param toolId: The tool Id.
	 * @param projectId: The project Id.
	...
	public UserTeamData generateUserTeamData(String orgId, String toolId, String projectId, String qId)
		...
		return super.generateUserTeamData(orgId, toolId, projectId, CommonConstants.SPP_USERTEAM_DASHBOARD_ID, qId);
	}

	/**
	 * This method generates the JSON file required for generating the UserTeam
	 * Chart for Strategic Planning Process Tool for all the questions for the tool
	 * in the specified location and also returns the list of UserTeam Data.
	 * 
	 * @param orgId: The organization Id.
	 * @param toolId: The tool Id.
	 * @param projectId: The project Id.
	...
	public ArrayList<UserTeamData> generateUserTeamDataAllQuestions(String orgId, String toolId, String projectId)
		...
		return super.generateUserTeamDataAllQuestions(orgId, toolId, projectId,
				CommonConstants.SPP_USERTEAM_DASHBOARD_ID);
	}
